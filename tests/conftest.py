...
def lst_for_tests_csv_xlsx() -> list:
    ...
    return [
        ...
        {
            "Дата операции": Timestamp("2021-12-31 16:42:04"),
            "Номер карты": "*7197",
            "Статус": "OK",
            "Сумма операции": -64.0,
            "Валюта операции": "RUB",
        ...
        {
            "Дата операции": Timestamp("2021-12-31 15:44:39"),
            "Номер карты": "*7197",
            "Статус": "OK",
        ...
        {
            "Дата операции": Timestamp("2021-12-31 01:23:42"),
            "Номер карты": "*5091",
            "Статус": "OK",
        ...
        {
            "Дата операции": Timestamp("2021-12-30 19:18:22"),
            "Номер карты": "*5091",
            "Статус": "OK",
            "Сумма операции": -7.07,
            "Валюта операции": "RUB",
        ...
        {
            "Дата операции": Timestamp("2021-12-30 19:06:39"),
            "Номер карты": "*7197",
            "Статус": "OK",
            "Сумма операции": -1.32,
            "Валюта операции": "RUB",
        ...
        {
            "Дата операции": Timestamp("2021-12-30 17:50:30"),
            "Номер карты": "*4556",
            "Статус": "OK",
